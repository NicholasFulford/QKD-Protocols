...
qkdcode - BB84 QKD protocol implementations with eavesdropping and noise models.
    ...
    - Eavesdropping attack classes for two interception-resend attacks and security analysis.
...
from qkdcode.eavesdropping import RandomInterceptResendEve, BreidbartEve, compare_bb84_attacks
